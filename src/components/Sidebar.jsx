  ...
  return (
    <aside style={styles.sidebar}>
      <div style={styles.header}>
        ...
        <h2 style={styles.title}>band<span style={styles.iaHighlight}>I'A</span>kama</h2>
      </div>
...
const getStyles = (darkMode) => ({
  ...
  logoBadge: { width: '38px', height: '38px', borderRadius: '13px', background: accentGradient, display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: `0 0 18px ${darkMode ? 'rgba(124,92,250,0.55)' : 'rgba(124,92,250,0.35)'}`, flexShrink: 0 },
  title: { fontSize: '21px', fontWeight: '700', margin: 0, color: darkMode ? '#ffffff' : '#0f172a', letterSpacing: '0.3px', fontFamily: "'Baloo 2', 'Inter', sans-serif" },
  iaHighlight: { fontWeight: '700', background: accentGradient, WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' },
