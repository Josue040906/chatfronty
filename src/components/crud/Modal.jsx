...
const getStyles = (darkMode, maxWidth) => ({
  ...
  card: { width: '100%', maxWidth, maxHeight: '85vh', overflowY: 'auto', backgroundColor: darkMode ? '#211935' : '#ffffff', border: darkMode ? '1px solid #2d234a' : '1px solid #e2e8f0', borderRadius: '18px', boxShadow: '0 20px 60px rgba(0,0,0,0.35)' },
  header: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '18px 22px', borderBottom: darkMode ? '1px solid #2d234a' : '1px solid #e2e8f0' },
